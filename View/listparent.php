  ...
  <table class="table table-hover">
     <thead>
       <tr>
                    ...
                    <th scope="col">GuardianProffession</th>
                    <th scope="col">MotherProffession</th>
                ...
                <?php
                  ...
                  $Class = new parent1;
                  $i= $Class->DisplayParentTable();
                for($x=0;$x<=$i;$x++){
                    echo "<tr>";

                    echo "<td>".$Class->Name[$x]."</td>";

                    echo "<td>".$Class->Mobile[$x]."</td>";

                    echo "<td>".$Class->Email[$x]."</td>";

                    echo "<td>".$Class->AddressID[$x]."</td>";

                    echo "<td>".$Class->HomePhone[$x]."</td>";

                    echo "<td>".$Class->Nationality[$x]."</td>";

                    echo "<td>".$Class->Gender[$x]."</td>";

                    echo "<td>".$Class->MotherName[$x]."</td>";

                    echo "<td>".$Class->GuardianProfession[$x]."</td>";

                    echo "<td>".$Class->MotherProfession[$x]."</td>";
